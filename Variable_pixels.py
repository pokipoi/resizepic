...
def adjust_image_size(input_folder, output_folder, multiple):
    # 确保输出文件夹存在
    ...
    for filename in os.listdir(input_folder):
        if filename.lower().endswith(('png', 'jpg', 'jpeg', 'gif', 'bmp')):
            ...
            with Image.open(file_path) as img:
                ...
                print(f"pic '{filename}' Successfully saved to '{output_folder}'")
...
if __name__ == '__main__':
    ...
    # 提示用户输入需要调整的倍数
    multiple = int(input("Please enter the multiplier you want to adjust: "))
    
    adjust_image_size(input_folder, output_folder, multiple)